...
function buildUserEmail(name:string,subject:string){
...
subject:`[EduPilot Help] [${category}] ${subject}`,
...
subject:"EduPilot Support Ticket Received",

html:buildUserEmail(name,subject)
