...
type ToolMode = "chat" | "web_search" | "image_generation" | "video_generation"
...
function AITutorContent() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (activeMode === "image_generation") {
      ...
      } else if (activeMode === "video_generation") {
        if (!messageText) {
        ...
        setMessages((prev) => [
          ...prev,
          {
            id: (Date.now() + 1).toString(),
            role: "assistant",
            content: `Your video request is ready for: **${messageText}**`,
            timestamp: new Date(),
                ...
                <div className="relative flex-1">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-56">
                      <DropdownMenuItem onClick={() => handleToolSelect("video_generation")} className="gap-2">
